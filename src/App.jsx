...
const Hero = React.memo(({ movie, isFocused, activeBtnIndex, onPlay, isModalOpen, isNavFocused }) => {
...
const SearchScreen = ({ searchQuery, setSearchQuery, searchResults, activeRow, activeCol, onMovieClick, rowRefMap }) => {
  ...
  return (
    <div className={`w-full min-h-screen flex flex-col items-center pt-[14vw] text-white transition-all duration-500 ${isPageActive ? 'opacity-100 blur-0' : 'opacity-40'}`}>
